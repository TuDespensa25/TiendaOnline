...
function setMobileViewport() {
  if (window.innerWidth <= 768) {
    // El viewport se define en el HTML y no se toca: bloquear el zoom impedia
    // ampliar la foto del producto y leer el gramaje.
  ...
  },*/
{
 ...
 /* {
  ...
  },*/
  {
    ...
    precio: 18.50,
    imagen: "combopolloaceiterefresco.webp",
